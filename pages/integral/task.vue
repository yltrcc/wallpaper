<template>
	<view>
		<view class="" v-show="!loadShow">
			<u-navbar :is-back="true" title="积分任务" title-width="325" title-color="#333333" title-size="28" :border-bottom="false"></u-navbar>
			<view class="top">
				<view class="icon u-flex u-row-center u-col-center u-p-t-20"><image src="../../static/icon/jinbi.png"></image></view>
			...
			<view class="u-p-l-40 u-p-r-40">
				...
				<view class="safe-area-inset-bottom">
					...
					<view class="tab u-flex u-row-between u-col-center border-bottom u-p-t-30 u-p-b-30">
						<view class="u-flex u-row-left u-col-center">
							<view class="icon u-flex u-row-center u-col-center"><u-icon name="/static/icon/user2.png" size="46"></u-icon></view>
							<view class="u-p-l-20 u-p-t-10">
								<view class="">每日签到</view>
								<view class="u-font-12 u-light-color">+{{ signIntegral }}积分/天</view>
							</view>
						</view>
						<view class="btn" hover-class="hover-class" hover-stay-time="50" @click="signClick">去签到</view>
					</view>
					<view class="tab u-flex u-row-between u-col-center border-bottom u-p-t-30 u-p-b-30">
						<view class="u-flex u-row-left u-col-center">
							<view class="icon u-flex u-row-center u-col-center"><u-icon name="/static/icon/user1.png" size="46"></u-icon></view>
							<view class="u-p-l-20 u-p-t-10">
					...
					<view class="tab u-flex u-row-between u-col-center border-bottom u-p-t-30 u-p-b-30" v-if="adUnitId">
						<view class="u-flex u-row-left u-col-center">
							<view class="icon u-flex u-row-center u-col-center"><u-icon name="/static/icon/video.png" size="46"></u-icon></view>
							<view class="u-p-l-20 u-p-t-10">
								<view class="">看广告</view>
